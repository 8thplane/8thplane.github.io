---
title: 'Methods Matter : Rcode 4.investigator-Designed Randomized Experiments'
author: Jong Hoon Kim, PH. D.
date: '2022-01-15'
slug: methods-matter-rcode-4-investigator-designed-randomized-experiments
categories:
  - R
tags:
  - R Markdown
...
```{r}
lawstat::levene.test(post_ach~voucher, data = nyvoucher)
```
